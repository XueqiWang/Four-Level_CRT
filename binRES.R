...
axis(1, 1, las = 1, cex.axis = 1.0)
axis(1, seq(5, 30, by = 5), las = 1, cex.axis = 1.0)
axis(1, seq(1, 30, by = 1), labels=F, tick=T, las = 1, cex.axis = 1.5) 
axis(2, seq(0.01, 0.09, by = 0.01), las = 1, cex.axis = 1.0) 
...
axis(1, seq(5, 30, by = 5), las = 1, cex.axis = 1.0)
axis(1, seq(1, 30, by = 1), labels=F, tick=T, las = 1, cex.axis = 1.5) 
axis(2, round(seq(-0.15, 0.05, by = 0.025),3), las = 1, cex.axis = 1.0) 
...
# Figures of results
# Size and Power
# (The following code is for plotting CV = 0.25 compared to CV = 0.00,
# i.e. Web Figures 1 and 2 in the supporting information.
# The code can be adpated to plotting CV = 0.50/0.75/1.00 compared to 
# CV = 0.00 by changing "final_bin<-final_bin_MAEE_25" to
# "final_bin<-final_bin_MAEE_50"/"final_bin<-final_bin_MAEE_75"/
# "final_bin<-final_bin_MAEE_100" in line 225, 261, 299, and 335, and
# modifying the corresponding legend in line 257, 293, 331 and 367)
##################################################
...
axis(1, seq(5, 30, by = 5), las = 1, cex.axis = 1.0)
axis(1, seq(1, 30, by = 1), labels=F, tick=T, las = 1, cex.axis = 1.5) 
axis(2, seq(0, 0.09, by = 0.01), las = 1, cex.axis = 1.0) 
...
axis(1, seq(5, 30, by = 5), las = 1, cex.axis = 1.0)
axis(1, seq(1, 30, by = 1), labels=F, tick=T, las = 1, cex.axis = 1.5) 
axis(2, round(seq(-0.2, 0.1, by = 0.025),3), las = 1, cex.axis = 1.0) 
