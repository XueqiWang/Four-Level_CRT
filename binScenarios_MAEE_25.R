...
binSIMULATE<-function(n,m,k,l,beta,alpha){
  ...
  if(beta[2]-beta[1]==0){
    ...
    name<-"Power"}
  save(results,file=paste0(name,"_beta_var_25.RData"))
  save(results0,file=paste0(name,"_alpha0_var_25.RData"))
  save(results1,file=paste0(name,"_alpha1_var_25.RData"))
  save(results2,file=paste0(name,"_alpha2_var_25.RData"))
}
